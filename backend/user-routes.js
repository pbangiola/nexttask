...
router.get('/users/:userId/work-plan',(req,res)=>{try{userStore.claimUnownedTasks(req.params.userId);res.json(actionabilityStore.getTimeFitPlan(req.params.userId,req.query.availableMs));}catch(error){return badRequest(res,error);}});
